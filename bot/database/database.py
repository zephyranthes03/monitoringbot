...
async def insert_service_data(chat_id:str, service_info:ServiceModel):
    ...
    if redis_client:
        ...
        service_data_model_info = ServiceDataModel('host':service_info.host, 'port':service_info.port, 'time':service_info.time, 'status': 'init', 'last_check_time':datetime.now() + timedelta(minutes=service_info.time))
...
async def remove_service_data(chat_id:str, service_info:ServiceModel):
    # Get the singleton instance of the AsyncDatabase class
    database = Database()
...
async def get_service_data(chat_id:str) -> dict():
    # Get the singleton instance of the AsyncDatabase class
    database = Database()
